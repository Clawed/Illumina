...
<img class="active-habbo-imagemap" src="{$www}/images/web-gallery/v2/images/activehomes/transparent_area.gif" width="435px" height="230px" usemap="#habbomap" />
{function="lightcms::drawRandomHabbos()"} 
