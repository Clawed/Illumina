...
class RainTPL{
	...
	// -------------------------
		 ...
		 * @var string
		 */
		public static $tpl_dir = "engine/templates/";
		 ...
		 * @var array
		 */
		static $path_replace_list = array( 'asdfgh' );
	...
	protected function check_template( $tpl_name ){
		...
		if( !isset($this->tpl['checked']) ){
			...
			if( self::$check_template_update && !file_exists( $this->tpl['tpl_filename'] ) ){
				...
				$this->tplError('Template \'' . $tpl_basename . '\' does not exist.');
			}
